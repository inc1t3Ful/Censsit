...
function censor(){
    ...
    for (var i = 0; i<x.length; i++) {
        ...
        for (var j = 0; j< comment.length; j++) {
            ...
            for (var k = 0; k<badWords.length; k++){
                if (comment[j] == badWords[k]){
                    // console.log(comment[j] + " count: " + count);
                    badword = true;
                    break;
                }   
            }
        ...
        if (badword){
            text.innerHTML = "Comment is inappropriate";
    ...
    //     var comment = x[i].innerHTML.toLowerCase();
    //     console.log(comment);

             
    //     for (var k = 0; k<badWords.length; k++){
    //         if (comment.indexOf(badWords[k]) != -1){
    //             // var res = comment[j].split(' ');
    //             // console.log(comment[j] + ": " + badWords[k] + ", res: " + res);

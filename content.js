...
function main(){
    ...
    for (var j = 0; j<x.length; j++){
        ...
        if (blockComment){
                var why = document.getElementsByClassName("md");
            ...
            nlpreq.onreadystatechange = function() {
              if(nlpreq.readyState == 4 && nlpreq.status == 200) {
                ...
                if (sentiment < -0.5 && magnitude > 0.6) {
                    ...
                    why[j].innerText = "This comment contains offensive language and has been filtered.";

                    //console.log(confirmBlock);

                  }
                  else why[j].style.backgroundColor = "black";
                }
              }    
